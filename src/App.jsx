  ...
  const loadCommentary = async (item) => {
      ...
      try {
          ...
          let filteredComm = (d.commentary || []).filter(c => {
              ...
              const tEn = (c.collectiveTitle?.en || c.index_title || "").toLowerCase(), tHe = c.collectiveTitle?.he || "";
